...
curl -X PUT http://admin:pass@127.0.0.1:5985/_node/couchdb@127.0.0.1/_config/couch_httpd_auth/require_valid_user \
...
curl -X PUT --data '"stderr"' http://admin:pass@127.0.0.1:5985/_node/couchdb@127.0.0.1/_config/log/writer
curl -X PUT --data '"warn"' http://admin:pass@127.0.0.1:5985/_node/couchdb@127.0.0.1/_config/log/level
